...
console.log(
  `${colors.blue}${colors.bold}=== Application Insights Migration Tool ===${colors.reset}\n`,
);
console.log(
  `${colors.yellow}This script will update all references to the Application Insights connection string.${colors.reset}`,
);
