...
export {
  getFeedbackEmailTemplate1,
  getFeedbackEmailTemplate2,
  getFeedbackEmailTemplate3,
  getFeedbackEmailTemplate4,
};
...
export function getFeedbackEmailTemplate(
  ...
  switch (sequencePosition) {
    ...
    default:
      throw new Error(
        `Invalid feedback email sequence position: ${sequencePosition}. Must be 1-4.`,
      );
  }
}
