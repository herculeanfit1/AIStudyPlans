      ...
      <div className="container mx-auto px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-indigo-100 mb-8">
            Be the first to get access when we launch. We're currently in the final stages of
            development.
          </p>
          ...
          <form className="bg-white p-6 rounded-lg shadow-md" onSubmit={handleSubmit}>
            ...
            {submitMessage && (
              <div
                className={`mt-4 p-3 rounded ${submitMessage.type === "success" ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"}`}
              >
                {submitMessage.text}
              </div>
            )}
