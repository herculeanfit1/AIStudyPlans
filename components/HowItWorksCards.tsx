  ...
  return (
    <div className="relative group">
      ...
      >
        {/* Numbered badge */}
        <div
          className="absolute -top-5 -right-3 w-12 h-12 rounded-full bg-blue-600 text-white
  ...
  const steps: StepCardProps[] = [
    {
      ...
      description:
        "Tell us about your learning style, schedule, and current knowledge level so we can personalize your experience.",
    ...
    },
    {
      ...
      description:
        "Choose what you want to learn and set specific goals for each subject. Add deadlines if you have them.",
    ...
    },
    {
      ...
      description:
        "Our AI generates a study plan optimized for your learning style, schedule, and goals.",
    ...
    },
    {
      ...
      title: "Track & Improve",
      description:
        "Follow your plan and track progress. Our AI adapts to your performance, continuously optimizing your study strategy.",
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="md:w-1/2 mb-6 md:mb-0">
                ...
                <p className="text-gray-600 mb-4">
                  Join our waitlist and be the first to experience the future of personalized
                  learning.
                </p>
                <a
                  href="#waitlist"
                  className="inline-flex items-center justify-center py-3 px-6 rounded-lg bg-blue-600 text-white font-medium transition-colors hover:bg-blue-700"
                >
                  Join the Waitlist
                </a>
              </div>
