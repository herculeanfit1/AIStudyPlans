...
import { FaBrain, FaChalkboardTeacher, FaRegLightbulb, FaRocket } from "react-icons/fa";
    ...
    <div className="container max-w-6xl mx-auto px-4 py-12">
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Personalized AI-powered study plans and learning resources tailored to your educational
          goals
        </p>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 mb-4">
            Our core offering provides custom study plans based on your learning style, goals, and
            schedule. We analyze your needs and create a structured approach to help you achieve
          ...
          <Link
            href="/pricing"
            className="inline-block px-6 py-2.5 bg-blue-600 text-white rounded hover:bg-blue-700 transition font-medium"
          >
            View Plans
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 mb-4">
            Struggling with specific concepts? Our Concept Mastery service identifies knowledge gaps
            and creates targeted learning materials to help you overcome challenging topics across
            any subject.
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <Link
            href="/pricing"
            className="inline-block px-6 py-2.5 bg-purple-600 text-white rounded hover:bg-purple-700 transition font-medium"
          >
            Learn More
          </Link>
        </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 mb-4">
            Facing an important test? Our Exam Preparation service creates a structured study plan
            with practice tests, review materials, and targeted strategies designed specifically for
            your upcoming exam.
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <Link
            href="/pricing"
            className="inline-block px-6 py-2.5 bg-green-600 text-white rounded hover:bg-green-700 transition font-medium"
          >
            Prepare Now
          </Link>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8">
          ...
          <p className="text-gray-700 mb-4">
            Everyone learns differently. Our Learning Style Optimization analyzes your unique
            learning preferences and creates a personalized approach that maximizes retention and
            understanding.
          </p>
          <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
          ...
          <Link
            href="/pricing"
            className="inline-block px-6 py-2.5 bg-yellow-600 text-white rounded hover:bg-yellow-700 transition font-medium"
          >
            Discover Your Style
          </Link>
        </div>
        ...
        <div className="grid md:grid-cols-4 gap-4">
          <div className="bg-white p-5 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              Share your learning objectives, timeline, and current knowledge level.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              Our AI analyzes your needs and creates a tailored learning approach.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              Receive a comprehensive, personalized study plan and resources.
            </p>
          </div>
          ...
          <div className="bg-white p-5 rounded-lg shadow-sm">
            ...
            <p className="text-gray-700">
              Monitor progress and receive adjustments as you learn and grow.
            </p>
          </div>
        </div>
      </div>
