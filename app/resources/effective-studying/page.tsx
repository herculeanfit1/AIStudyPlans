  ...
  const tabContent = {
          ...
          <div className="bg-gray-50 p-6 rounded-lg mt-4">
            ...
            <div className="flex flex-col space-y-4 sm:flex-row sm:space-y-0 sm:space-x-4">
              <div className="w-full sm:w-1/2">
                ...
                />
                <span className="block text-center text-sm font-medium mt-1">
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-700">
            ...
            increasing intervals. It's one of the most effective methods for long-term retention.
          </p>
    ...
    active: {
      ...
      content: (
        <div className="space-y-4">
          <p className="text-gray-700">
            Active learning involves engaging with the material through meaningful activities rather
            than passively consuming information. These techniques increase comprehension and
            retention.
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
            <div className="bg-indigo-50 p-4 rounded-md">
              ...
              <p className="text-gray-700 text-sm">
                Explain a concept in simple terms as if teaching someone else. This identifies gaps
            ...
            <div className="bg-indigo-50 p-4 rounded-md">
              ...
              <p className="text-gray-700 text-sm">
                Create visual diagrams that connect concepts and ideas, helping to organize
            ...
            <div className="bg-indigo-50 p-4 rounded-md">
              ...
              <p className="text-gray-700 text-sm">
                Create and take practice tests to strengthen retrieval pathways and identify weak
                areas.
              </p>
            </div>
            <div className="bg-indigo-50 p-4 rounded-md">
              ...
              <p className="text-gray-700 text-sm">
                Explaining concepts to others reinforces your own understanding and highlights areas
                needing review.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 bg-white border border-gray-200 rounded-md p-4">
            ...
            <p className="text-gray-600 text-sm mb-3">
              Pick a concept you're studying and try to explain it in simple terms below:
            </p>
            <textarea
            ...
            <p className="text-gray-600 text-sm mt-2">
              Notice any gaps in your explanation? Those are areas to review!
            </p>
          </div>
        </div>
      ),
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <Link href="/" className="inline-block mb-6">
            <Image src="/SchedulEd_new_logo.png" alt="AIStudyPlans Logo" width={180} height={48} />
          </Link>
          <h1 className="text-4xl font-bold text-gray-900 mb-4">Effective Studying Techniques</h1>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Science-backed methods to improve your study efficiency, retention, and overall learning
            experience.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white p-8 md:p-12">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg mb-6">
                Effective studying isn't about studying harder—it's about studying smarter. These
                evidence-based techniques can help you maximize your learning while minimizing
                burnout.
              </p>
          ...
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white p-8 md:p-12">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <p className="mb-6">
                Join our newsletter to receive the latest research-backed study techniques,
                productivity tips, and exclusive templates.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Link href="/resources/time-management" className="block">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 border border-gray-100 h-full flex flex-col">
                ...
                <p className="text-gray-600 mb-4 flex-grow">
                  Master your schedule with proven time management techniques specifically designed
            ...
            <Link href="/dashboard" className="block">
              <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition duration-300 border border-gray-100 h-full flex flex-col">
                ...
                <p className="text-gray-600 mb-4 flex-grow">
                  Get a custom AI-generated study plan tailored to your learning style, goals, and
                  schedule.
                </p>
                <span className="text-indigo-600 font-medium flex items-center">
                  Create your plan
