  ...
  const features = [
    {
      ...
      description:
        "Our AI algorithm creates personalized study plans based on your learning style, goals, and schedule.",
    },
    {
      icon: <i className="fas fa-clock text-indigo-600 dark:text-indigo-400 text-2xl"></i>,
      title: "Time Optimization",
      description:
        "Maximize your study efficiency with scientifically-proven time management techniques.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Your plan evolves based on your performance, focusing more time on challenging areas.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Connect with peers studying similar subjects for group sessions and knowledge sharing.",
    },
  ];
    ...
    <section id="features" className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-gray-100 mt-2 mb-4">
            Features Designed for Student Success
          </h2>
          <p className="text-xl text-gray-600 dark:text-gray-300">
            Our platform combines cutting-edge AI with proven study techniques to help you achieve
            academic excellence.
          </p>
        </motion.div>
