  ...
  const steps = [
    {
      ...
      description:
        "Tell us about your learning style, time availability, and current knowledge level to help us understand your unique needs.",
      icon: "fa-user-plus",
    },
    {
      number: 2,
      ...
      description:
        "Choose the subjects you want to learn and set specific learning goals to focus your study plans on what matters most to you.",
      icon: "fa-book-open",
    },
    {
      number: 3,
      ...
      description:
        "Our AI engine creates a personalized study plan optimized for your success, with the right balance of materials and activities.",
    ...
    },
    {
      ...
      title: "Track & Adapt",
      description:
        "Follow your plan, track your progress, and watch as our AI adapts your study schedule based on your performance and feedback.",
      icon: "fa-chart-line",
    },
  ];
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              ...
              >
                ...
                >
                  <div
                    className={`w-16 h-16 rounded-full flex items-center justify-center text-white text-xl mb-6 transition-all duration-300 ${
