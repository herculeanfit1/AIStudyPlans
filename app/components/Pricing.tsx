          ...
          {features.map((feature, featureIndex) => (
            <li key={featureIndex} className="flex items-start">
              {feature.included ? (
                ...
                <svg
                  className="h-5 w-5 text-gray-400 dark:text-gray-600 mt-0.5 mr-3 flex-shrink-0"
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <div className="flex items-center justify-center mb-8">
            <span
              className={`mr-3 text-sm ${annual ? "text-gray-900 font-medium" : "text-gray-500"}`}
            >
              Annual
            </span>
            ...
            <span
              className={`ml-3 text-sm ${!annual ? "text-gray-900 font-medium" : "text-gray-500"}`}
            >
              Monthly
            </span>
          </div>
