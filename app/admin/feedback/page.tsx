...
export default function FeedbackDashboard() {
  ...
  const prepareChartData = () => {
    ...
    const feedbackByRatingData = Object.entries(stats.feedbackByRating)
      .map(([label, value]) => ({
        label,
        value: value as number,
      }))
    ...
    <>
      ...
      {chartData && (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          <FeedbackLineChart title="Feedback Over Time" data={chartData.byDay} />

          <FeedbackDoughnutChart title="Feedback by Type" data={chartData.byType} />

          <FeedbackBarChart title="Feedback by Rating" data={chartData.byRating} />
      ...
      {/* Filters */}
      <FeedbackFiltersComponent onFilterChange={handleFilterChange} isLoading={isLoading} />
