      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        <div className="terms-content">
          ...
          <p className="mb-4">
            ...
            mobile applications, or any other features, technologies, or functionalities offered by
            us on our website, through any platform, device, or interface (collectively, the
          ...
          <p className="mb-4">
            ...
            notice of any material changes by updating the "Last Updated" date at the top of this
            page. Your continued use of the Services after any such changes constitutes acceptance
          ...
          <p className="mb-2">
            Our Services allow you to create study plans and store educational content ("User
            Content"). You retain all rights to your User Content, but you grant us a worldwide,
            non-exclusive, royalty-free license to use, reproduce, modify, adapt, publish,
            translate, and distribute such content in connection with providing our Services.
          </p>
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              Share inappropriate content, including content that is harmful, threatening, abusive,
              harassing, defamatory, or pornographic
            </li>
          ...
          <p className="mb-4">
            The Services and their content, features, and functionality are owned by
            AIStudyPlans.com and are protected by copyright, trademark, and other intellectual
            property laws. You may not use our trademarks, logos, or service marks without our prior
            written consent.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-3">7. Subscription Services</h2>
          <p className="mb-2">
            Some of our Services require payment of fees for access to premium features ("Premium
            Services"). If you subscribe to our Premium Services:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              Fees are non-refundable except as required by law or expressly stated in our refund
              policy
            </li>
          </ul>
          ...
          <p className="mb-4">
            We reserve the right to terminate or suspend your account and access to the Services at
            our sole discretion, without notice, for conduct that we believe violates these Terms or
            is harmful to other users of the Services, us, or third parties, or for any other
            reason.
          </p>
          ...
          <p className="mb-4">
            TO THE FULLEST EXTENT PERMITTED BY LAW, IN NO EVENT SHALL AISTUDYPLANS.COM, ITS
            AFFILIATES, OR THEIR RESPECTIVE OFFICERS, DIRECTORS, EMPLOYEES, OR AGENTS BE LIABLE FOR
            ANY INDIRECT, INCIDENTAL, SPECIAL, CONSEQUENTIAL, OR PUNITIVE DAMAGES, INCLUDING LOST
            PROFITS, ARISING OUT OF OR RELATING TO THE USE OF OR INABILITY TO USE THE SERVICES.
          </p>

          <h2 className="text-xl font-semibold mt-6 mb-3">11. Indemnification</h2>
          <p className="mb-4">
            You agree to indemnify, defend, and hold harmless AIStudyPlans.com and its officers,
          ...
          <p className="mb-4">
            ...
            of California, without regard to its conflict of law principles. Any dispute arising
            from these Terms shall be resolved exclusively in the state or federal courts located in
          ...
          <p className="mb-8">
            AIStudyPlans.com
            <br />
            <a href="mailto:legal@aistudyplans.com" className="text-blue-600">
              legal@aistudyplans.com
            </a>
          </p>
