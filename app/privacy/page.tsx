      ...
      <div className="bg-white rounded-lg shadow-md p-6 mb-8">
        ...
        {activeTab === "general" && (
          <div className="privacy-content">
            ...
            <p className="mb-4">
              AIStudyPlans.com ("we", "our", or "us") is committed to protecting your privacy. This
              Privacy Policy explains how we collect, use, disclose, and safeguard your information
              when you visit our website or use our services. Please read this privacy policy
            ...
            <p className="mb-4">
              ...
              destruction. Despite our efforts, no security measures are perfect, and we cannot
            ...
            <p className="mb-4">
              To exercise these rights, please contact us at privacy@aistudyplans.com.
            </p>
            ...
            <p className="mb-4">
              ...
              from a child under 13, we will delete that information. For users between 13-17 years
              old, please review our{" "}
              <button className="text-blue-600 underline" onClick={() => setActiveTab("minors")}>
            ...
            <p className="mb-4">
              AIStudyPlans.com
              <br />
              <a href="mailto:privacy@aistudyplans.com" className="text-blue-600">
        ...
        {activeTab === "minors" && (
          <div className="minors-privacy-content">
            ...
            <div className="bg-blue-50 border-l-4 border-blue-500 p-4 rounded mb-6">
              ...
              <p>
                This policy explains how AI Study Plans collects, uses, and protects data from users
                between 13-17 years old. We're committed to protecting your child's privacy while
            ...
            <p className="mb-4">
              AI Study Plans is designed for users aged 13 and older. We are committed to complying
              with laws protecting minors online, including the Children's Online Privacy Protection
              Act (COPPA) and other applicable privacy regulations. This policy specifically
              addresses how we handle information from users between 13-17 years old.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">
              2. Information We Collect from Youth Users
            </h3>
            ...
            <ul className="list-disc pl-6 mb-4 space-y-1">
              ...
              <li>
                Send email notifications about study plans and progress (to parent-approved email
                addresses)
              </li>
            </ul>
            <p className="mb-2 font-medium">
              We <span className="font-bold">never</span> use youth data for:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <div className="bg-yellow-50 border-l-4 border-yellow-500 p-4 rounded mb-6 mt-4">
              ...
              <ul className="list-disc pl-6 mb-2 space-y-1">
                <li>
                  Request to review any personal information we have collected from their child
                </li>
            ...
            <p className="mb-2">
              To protect our youth users, we implement the following safety measures:
            </p>
            <ul className="list-disc pl-6 mb-4 space-y-1">
              ...
              <li>
                Local resource recommendations are limited to established educational institutions
              </li>
            </ul>

            <h3 className="text-xl font-semibold mt-6 mb-3">6. Data Retention and Deletion</h3>
            <p className="mb-4">
              We store youth user data only as long as necessary to provide our educational services
              or as required by law. Parents/guardians can request the deletion of their child's
            ...
            <p className="mb-4">
              These services receive limited data necessary for their specific function and are
              bound by their own privacy policies and our data processing agreements.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">8. US-Only Availability</h3>
            <p className="mb-4">
              AI Study Plans is currently available only to users located in the United States. This
              helps us ensure compliance with US privacy laws regarding minors.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">9. Changes to This Policy</h3>
            <p className="mb-4">
              If we make material changes to how we collect, use, or share youth user data, we will
              notify parents/guardians via email and require renewed consent where applicable.
            </p>

            <h3 className="text-xl font-semibold mt-6 mb-3">10. Contact Us</h3>
            <p className="mb-2">
              If you have questions or concerns about our youth privacy practices, please contact us
              at:
            </p>
            <address className="mb-6 not-italic">
              <strong>AI Study Plans Privacy Team</strong>
              <br />
              <a href="mailto:privacy@aistudyplans.com" className="text-blue-600">
                privacy@aistudyplans.com
              </a>
