          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-brain text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              ...
              <p className="text-gray-600">
                Study plans tailored to your learning style (visual, auditory,
                kinesthetic), time availability, and knowledge level.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-calendar-alt text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-600">
                Optimize your study time with intelligently scheduled sessions
                that match your availability and peak productivity hours.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-book-open text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-600">
                Access high-quality educational materials specifically chosen to
                match your learning style and subject matter.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-chart-line text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-600">
                ...
                analytics to keep you motivated.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-bell text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-600">
                Never miss a study session with timely reminders and calendar
                integration for upcoming study sessions.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <div className="w-16 h-16 bg-indigo-100 rounded-full flex items-center justify-center mb-6">
                <i
                  className="fas fa-users text-2xl text-indigo-600"
                  aria-hidden="true"
                ></i>
              </div>
              <h3 className="text-xl font-bold text-gray-800 mb-4">
              ...
              <p className="text-gray-600">
                Enhanced protection for all users with special safeguards for
                students under 18, including parental controls.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Tell us about your learning style, time availability, and
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Our AI generates a personalized study plan optimized for your
                  success.
                </p>
              </div>
              ...
              <div className="text-center">
                ...
                <p className="text-gray-600">
                  Follow your plan, track progress, and watch our AI adapt as
                  you learn.
                </p>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-8">
                Join the SchedulEd Waitlist
              </h2>
              <p className="text-xl text-indigo-100 mb-10">
                Be the first to get access when we launch. We're currently in
                the final stages of development and will be inviting users in
                soon.
              </p>
              <WaitlistForm />
            </div>
      ...
      <footer className="bg-gray-800 text-gray-300 py-12">
        <div className="container mx-auto px-4">
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
            <p>
              &copy; {new Date().getFullYear()} SchedulEd. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
