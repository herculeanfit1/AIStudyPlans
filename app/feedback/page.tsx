...
function FeedbackFormContent() {
  ...
  const [feedbackType, setFeedbackType] = useState<
    "feature_request" | "general" | "improvement" | "bug"
  >("general");
    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md mx-auto bg-white rounded-xl shadow-md overflow-hidden md:max-w-2xl">
        <div className="p-8">
          ...
          <h2 className="text-2xl font-bold text-center text-gray-900 mb-4">{getTitle()}</h2>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-sm text-green-700">
                    ...
                    Your input helps us improve SchedulEd and build features you actually want to
                    use.
                  </p>
                  <div className="mt-4">
                    <button
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) =>
                    setFeedbackType(
                      e.target.value as "feature_request" | "general" | "improvement" | "bug",
                    )
                  }
